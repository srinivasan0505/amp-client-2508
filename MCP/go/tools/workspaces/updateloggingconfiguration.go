...
func UpdateloggingconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUpdateloggingconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_workspaces_workspaceId_logging",
		mcp.WithDescription("Update logging configuration."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateloggingconfigurationHandler(cfg),
	}
}
