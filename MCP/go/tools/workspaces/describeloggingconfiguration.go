...
func DescribeloggingconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DescribeLoggingConfigurationResponse
...
func CreateDescribeloggingconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_workspaces_workspaceId_logging",
		mcp.WithDescription("Describes logging configuration."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribeloggingconfigurationHandler(cfg),
	}
}
