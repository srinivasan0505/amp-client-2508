...
func CreatealertmanagerdefinitionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PutAlertManagerDefinitionrequest
		...
		url := fmt.Sprintf("%s/workspaces/%s/alertmanager/definition", cfg.BaseURL, workspaceId)
...
func CreateCreatealertmanagerdefinitionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_workspaces_workspaceId_alertmanager_definition",
		mcp.WithDescription("Create an alert manager definition."),
		...
		mcp.WithString("workspaceId", mcp.Required(), mcp.Description("The ID of the workspace in which to create the alert manager definition.")),
		mcp.WithString("data", mcp.Required(), mcp.Description("Input parameter: The alert manager definition data.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreatealertmanagerdefinitionHandler(cfg),
	}
}
