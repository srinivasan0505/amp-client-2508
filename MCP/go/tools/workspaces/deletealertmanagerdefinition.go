...
func DeletealertmanagerdefinitionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/workspaces/%s/alertmanager/definition%s", cfg.BaseURL, workspaceId, queryString)
...
func CreateDeletealertmanagerdefinitionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_workspaces_workspaceId_alertmanager_definition",
		mcp.WithDescription("Deletes an alert manager definition."),
		...
		mcp.WithString("workspaceId", mcp.Required(), mcp.Description("The ID of the workspace in which to delete the alert manager definition.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeletealertmanagerdefinitionHandler(cfg),
	}
}
