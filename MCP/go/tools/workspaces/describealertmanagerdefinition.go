...
func DescribealertmanagerdefinitionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DescribeAlertManagerDefinitionResponse
...
func CreateDescribealertmanagerdefinitionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_workspaces_workspaceId_alertmanager_definition",
		mcp.WithDescription("Describes an alert manager definition."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribealertmanagerdefinitionHandler(cfg),
	}
}
