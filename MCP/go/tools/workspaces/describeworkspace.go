...
func DescribeworkspaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/workspaces/%s", cfg.BaseURL, workspaceId)
		...
		var result models.DescribeWorkspaceResponse
...
func CreateDescribeworkspaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_workspaces_workspaceId",
		mcp.WithDescription("Describes an existing AMP workspace."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DescribeworkspaceHandler(cfg),
	}
}
