...
func UpdateworkspacealiasHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.UpdateWorkspaceAliasrequest
		...
		url := fmt.Sprintf("%s/workspaces/%s/alias", cfg.BaseURL, workspaceId)
...
func CreateUpdateworkspacealiasTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_workspaces_workspaceId_alias",
		mcp.WithDescription("Updates an AMP workspace alias."),
		...
		mcp.WithString("workspaceId", mcp.Required(), mcp.Description("The ID of the workspace being updated.")),
		mcp.WithString("alias", mcp.Description("Input parameter: A user-assigned workspace alias.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateworkspacealiasHandler(cfg),
	}
}
