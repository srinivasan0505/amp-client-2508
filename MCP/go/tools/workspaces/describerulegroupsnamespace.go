...
func DescriberulegroupsnamespaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.DescribeRuleGroupsNamespaceResponse
...
func CreateDescriberulegroupsnamespaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_workspaces_workspaceId_rulegroupsnamespaces_name",
		mcp.WithDescription("Describe a rule groups namespace."),
		...
		mcp.WithString("workspaceId", mcp.Required(), mcp.Description("The ID of the workspace to describe.")),
		mcp.WithString("name", mcp.Required(), mcp.Description("The rule groups namespace.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    DescriberulegroupsnamespaceHandler(cfg),
	}
}
