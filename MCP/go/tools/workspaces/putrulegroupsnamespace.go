...
func PutrulegroupsnamespaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PutRuleGroupsNamespacerequest
		...
		url := fmt.Sprintf("%s/workspaces/%s/rulegroupsnamespaces/%s", cfg.BaseURL, workspaceId, name)
...
func CreatePutrulegroupsnamespaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_workspaces_workspaceId_rulegroupsnamespaces_name",
		mcp.WithDescription("Update a rule groups namespace."),
		...
		mcp.WithString("workspaceId", mcp.Required(), mcp.Description("The ID of the workspace in which to update the rule group namespace.")),
		mcp.WithString("name", mcp.Required(), mcp.Description("The rule groups namespace name.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    PutrulegroupsnamespaceHandler(cfg),
	}
}
