...
func DeleteworkspaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/workspaces/%s%s", cfg.BaseURL, workspaceId, queryString)
...
func CreateDeleteworkspaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_workspaces_workspaceId",
		mcp.WithDescription("Deletes an AMP workspace."),
		...
		mcp.WithString("workspaceId", mcp.Required(), mcp.Description("The ID of the workspace to delete.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteworkspaceHandler(cfg),
	}
}
