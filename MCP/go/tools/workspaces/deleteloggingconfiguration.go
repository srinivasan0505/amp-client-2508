...
func DeleteloggingconfigurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/workspaces/%s/logging%s", cfg.BaseURL, workspaceId, queryString)
...
func CreateDeleteloggingconfigurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_workspaces_workspaceId_logging",
		mcp.WithDescription("Delete logging configuration."),
