...
func CreateworkspaceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.CreateWorkspacerequest
		...
		url := fmt.Sprintf("%s/workspaces", cfg.BaseURL)
...
func CreateCreateworkspaceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_workspaces",
		mcp.WithDescription("Creates a new AMP workspace."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    CreateworkspaceHandler(cfg),
	}
}
